...
class purchase_order(orm.Model):
    ...
    def _prepare_landed_cost_inv(self, cr, uid, landed_cost, context=None):
        ...
        fiscal_position_id = landed_cost.partner_id.property_account_position and landed_cost.partner_id.\
    ...
    def _generate_invoice_from_landed_cost(self, cr, uid, landed_cost,
        ...
        fiscal_position = (landed_cost.partner_id.property_account_position or po.fiscal_position or False)
